...
describe('ConnectionPool', () => {
  ...
  describe('executeRequest', () => {
    ...
    it('should retry failed requests', async () => {
      ...
      const result = await connectionPool.executeRequest(mockRequest, { retries: 3 });
    ...
    it('should handle timeout', async () => {
      ...
      await expect(
        connectionPool.executeRequest(mockRequest, { timeout: 50 })
      ).rejects.toThrow();
    }, 5000);
    ...
    it('should respect priority in request queue', async () => {
      ...
      const highPriorityPromise = connectionPool.executeRequest(highPriorityRequest, { priority: 10 });
      const lowPriorityPromise = connectionPool.executeRequest(lowPriorityRequest, { priority: 1 });
  ...
  describe('circuit breaker', () => {
    ...
    it('should close circuit breaker after successful request', async () => {
      ...
      const result = await connectionPool.executeRequest(mockRequest, { circuitBreaker: false });
  ...
  describe('pool optimization', () => {
    it('should optimize agents', () => {
      ...
      expect(optimizedMaxSockets).toBeGreaterThanOrEqual(Math.max(initialMaxSockets, 100));
    });

    it('should warm up connection pool', async () => {
      const spy = jest.spyOn(connectionPool as any, 'makeTestRequest')
  ...
  describe('retry logic', () => {
    it('should calculate retry delay with exponential backoff', () => {
      const calculateRetryDelay = (connectionPool as any).calculateRetryDelay.bind(connectionPool);
  ...
  describe('error handling', () => {
    ...
    it('should handle timeout errors', async () => {
      ...
      await expect(
        connectionPool.executeRequest(mockRequest, { timeout: 100, retries: 0 })
  ...
  describe('request ID generation', () => {
    it('should generate unique request IDs', () => {
      const generateRequestId = (connectionPool as any).generateRequestId.bind(connectionPool);
