...
import { EnhancedLogger, LoggerFactory, LogLevel } from '../services/enhanced-logger.service';
...
describe('EnhancedLogger', () => {
  ...
  describe('basic logging methods', () => {
    it('should log error messages with context', () => {
      ...
      expect(mockNestLogger.error).toHaveBeenCalledWith('Error occurred', error.stack);
  ...
  describe('Inngest-specific logging methods', () => {
    it('should log function start', () => {
      ...
      expect(parsedLog.message).toContain('Function func_123 execution started');
    ...
    it('should log function success', () => {
      ...
      expect(parsedLog.message).toContain('Function func_123 executed successfully');
    ...
    it('should log function error with InngestError', () => {
      const error = new InngestRuntimeError('Function failed', 'func_123', 'run_456');
    ...
    it('should log step execution', () => {
      logger.logStep('step_1', 'invoke', 'func_123', 'run_456', 'success', { result: 'ok' });
    ...
    it('should log step execution error', () => {
      ...
      logger.logStep('step_1', 'invoke', 'func_123', 'run_456', 'error', {}, error);
    ...
    it('should log event processing', () => {
      logger.logEvent('user.created', 'evt_123', 'processed', { source: 'api' });
    ...
    it('should log webhook processing', () => {
      logger.logWebhook('POST', 'func_123', 'received', 200, { userAgent: 'test' });
    ...
    it('should log performance metrics', () => {
      ...
      expect(parsedLog.message).toContain('Performance: database-query took 250ms');
  ...
  describe('trace logging', () => {
    it('should log with trace ID for correlation', () => {
      ...
      logger.logWithTrace(LogLevel.LOG, 'Traced message', traceId, { key: 'value' });
